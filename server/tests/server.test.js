...
const {Todo} = require('./../models/todo'); // access to the Todo model
...
describe('POST /todos', () => { // describe and group the tests
  ...
  //       }
  //       Todo.find().then((todos) => { // fetch all todos, then callback with a parameter and make assertions with such parameter
